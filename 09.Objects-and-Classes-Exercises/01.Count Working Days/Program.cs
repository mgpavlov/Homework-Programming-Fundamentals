...
namespace _01.Count_Working_Days
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //DateTime startDate = DateTime.ParseExact(startDateText, "dd-MM-yyy", CultureInfo.InvariantCulture);
              DateTime startDate = DateTime.ParseExact(startDateText, "dd-MM-yyyy", CultureInfo.InvariantCulture);

            //DateTime endDate = DateTime.ParseExact(endDateText, "dd-MM-yyy", CultureInfo.InvariantCulture);
